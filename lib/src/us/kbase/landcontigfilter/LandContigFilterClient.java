...
/**
 * <p>Original spec-file module name: landContigFilter</p>
 * <pre>
 * A KBase module: landContigFilter
 * This sample module contains one small method - filter_contigs.
 * </pre>
 */
public class LandContigFilterClient {
     ...
     */
    public LandContigFilterClient(URL url) {
     ...
     * validity.
     */
    public LandContigFilterClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public LandContigFilterClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public LandContigFilterClient(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("landContigFilter.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
