...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_Report_util_landml.filter_contigs,
                             name='Report_util_landml.filter_contigs',
                             types=[dict])
        self.method_authentication['Report_util_landml.filter_contigs'] = 'required'  # noqa
